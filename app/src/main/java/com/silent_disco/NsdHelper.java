...
public class NsdHelper {
    ...
    public static final String SERVICE_TYPE = "_silentdisco._udp.";

    public static final String TAG = "NsdHelper";
    public String mServiceName = "SilentDisco";
    ...
    public void registerListener(HelperListener helperListener) {
